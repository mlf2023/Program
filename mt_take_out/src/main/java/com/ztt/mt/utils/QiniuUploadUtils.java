...
public class QiniuUploadUtils {
    ...
    static String ACCESS_KEY = "yh5RIYcqi7EGz3o_sZ3S8ISUGTftEs5RmeloTq-V";
    static String SECRET_KEY = "O4mbA424jXimRjprAfDCRXgwYtYblpl-8Zs-wDf5";
    //要上传的空间;对应到七牛上（自己建文件夹 注意设置公开）
    static String bucketname = "mlf007";
    //上传文件的路径 ;本地要上传文件路径
    //  String FilePath = "C:\\Users\\Administrator\\Pictures\\good\\g1002\\g100201.jpg";
    //七牛云服务器存储空间的域名
    static String yuName = "http://rvi5s3p8g.hn-bkt.clouddn.com/";
    //密钥配置
    ...
    public static R uploadImage(MultipartFile file){
        try{
            ...
            //5.返回域名+图片名，让前端能够显示
            return R.success(yuName+newFileName);
        }catch (Exception e){
